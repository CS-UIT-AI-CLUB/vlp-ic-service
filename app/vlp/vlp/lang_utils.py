...
def language_eval(dataset, preds, model_id, split):
    ...
    if dataset == 'coco':
        ...
        #annFile = '/mlcv/Databases/Imagecaption/Dataset/viecap4h-public-train/VLP_format/annotations/coco_annotations.json'
        annFile = '/mlcv/Databases/Imagecaption/Dataset/viecap4h-public-train/VLP_format_train_full/annotations/coco_annotations.json'
