...
def main():
    ...
    # Self-defined
    parser.add_argument("--save_pred_path", default=None, type=str,
                        help="Path to save predictions")
    parser.add_argument("--lang_eval", action="store_true",
                        help="Evalaluation on result")

    # General
    parser.add_argument("--config_path", default=None, type=str,
                        help="Bert config file path.")
    parser.add_argument("--bert_model", default="custom-vocab-bert", type=str,
    ...
    for model_recover_path in glob.glob(args.model_recover_path.strip()):
            ...
            for src in img_dat:
                if src['split'] == args.split and (valid_jpgs is None or src['filename'] in valid_jpgs):
                    ...
                    if args.dataset == 'coco':
                        ...
                        imgid = int(src['filename'].split('_')[1][:-4])
        ...
        if args.save_pred_path:
            json.dump(predictions, open(args.save_pred_path, 'w', encoding='utf-8'))
